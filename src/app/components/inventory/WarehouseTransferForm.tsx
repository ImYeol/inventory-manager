...
export default function WarehouseTransferForm({ models, warehouses, initialWarehouseId, initialVariant, formId, onSubmitted }: { models: Model[]; warehouses: Warehouse[]; initialWarehouseId?: number; initialVariant?: InitialVariant; formId?: string; onSubmitted?: () => void }) {
