...
import { storeConnectionRow as _unused } from '@/components/ui/store-connection-row'
    ...
    <div className="space-y-4">
      {!embedded ? (
        <section className="rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3">
          ...
          <p className="mt-1 text-sm leading-6 text-slate-600">연결 상태를 확인하고 필요할 때만 값을 변경하세요.</p>
        </section>
      ) : null}
